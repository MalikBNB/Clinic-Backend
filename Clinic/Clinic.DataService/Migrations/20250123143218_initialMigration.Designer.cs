...
namespace Clinic.DataService.Migrations
{
    ...
    [Migration("20250123143218_initialMigration")]
            ...
            modelBuilder.Entity("Clinic.Entities.DbSets.Appointment", b =>
                {
                    ...
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "Modifier")
                        .WithMany()
                    ...
                    b.HasOne("Clinic.Entities.DbSets.User", null)
                        .WithMany("Appointments")
            ...
            modelBuilder.Entity("Clinic.Entities.DbSets.Payment", b =>
                {
                    b.HasOne("Clinic.Entities.DbSets.Appointment", "Appointment")
                        .WithOne("Payment")
                        .HasForeignKey("Clinic.Entities.DbSets.Payment", "AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
